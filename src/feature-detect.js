...
var detectLanguageOrDefault = function (lineOfText, defaultLanguage) {
    var detectedLanguages = languageDetector.detect(lineOfText);
    return detectedLanguages.length > 0
        ? detectedLanguages[0][0]
        : defaultLanguage;
};
var setSelectedStopWords = function (languageOfCurrentLine, languageOfWholeEmail) {
...
exports.detectFeaturesInText = function (lineOfText, language) {
    var detectedLangForCurrentLine = detectLanguageOrDefault(lineOfText, language);
    setSelectedStopWords(detectedLangForCurrentLine, language);
    var detectedFeatures = [];
    lineOfText = lineOfText.trim();
    exports.suppotedFeatures.forEach(function (feature) {
